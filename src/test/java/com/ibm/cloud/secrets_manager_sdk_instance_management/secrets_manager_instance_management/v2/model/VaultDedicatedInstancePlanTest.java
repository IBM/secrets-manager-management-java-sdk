...
/**
 * Unit test class for the VaultDedicatedInstancePlan model.
 */
public class VaultDedicatedInstancePlanTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testVaultDedicatedInstancePlan() throws Throwable {
    VaultDedicatedInstancePlan vaultDedicatedInstancePlanModel = new VaultDedicatedInstancePlan();
    assertNull(vaultDedicatedInstancePlanModel.getName());
  }
}