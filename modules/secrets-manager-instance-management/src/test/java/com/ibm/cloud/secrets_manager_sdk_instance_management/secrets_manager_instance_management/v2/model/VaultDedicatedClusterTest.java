...
/**
 * Unit test class for the VaultDedicatedCluster model.
 */
public class VaultDedicatedClusterTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testVaultDedicatedCluster() throws Throwable {
    VaultDedicatedCluster vaultDedicatedClusterModel = new VaultDedicatedCluster();
    assertNull(vaultDedicatedClusterModel.getStatus());
    assertNull(vaultDedicatedClusterModel.getVersion());
  }
}