...
/**
 * Unit test class for the CreateVaultAdmintokenOptions model.
 */
public class CreateVaultAdmintokenOptionsTest {
  ...
  public void testCreateVaultAdmintokenOptions() throws Throwable {
    CreateVaultAdmintokenOptions createVaultAdmintokenOptionsModel = new CreateVaultAdmintokenOptions.Builder()
      ...
      .build();
    assertEquals(createVaultAdmintokenOptionsModel.instanceId(), "bfc50c2e-d66d-4f37-9ccf-9713f8325b39");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateVaultAdmintokenOptionsError() throws Throwable {
    new CreateVaultAdmintokenOptions.Builder().build();
  }
