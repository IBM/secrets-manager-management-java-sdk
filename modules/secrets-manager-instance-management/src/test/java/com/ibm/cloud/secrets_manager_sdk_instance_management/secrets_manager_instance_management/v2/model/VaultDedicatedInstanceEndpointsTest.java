...
/**
 * Unit test class for the VaultDedicatedInstanceEndpoints model.
 */
public class VaultDedicatedInstanceEndpointsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testVaultDedicatedInstanceEndpoints() throws Throwable {
    VaultDedicatedInstanceEndpoints vaultDedicatedInstanceEndpointsModel = new VaultDedicatedInstanceEndpoints();
    assertNull(vaultDedicatedInstanceEndpointsModel.getXPublic());
    assertNull(vaultDedicatedInstanceEndpointsModel.getXPrivate());
  }
}