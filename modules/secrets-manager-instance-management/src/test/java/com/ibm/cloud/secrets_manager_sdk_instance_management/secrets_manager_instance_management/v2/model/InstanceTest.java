...
public class InstanceTest {
  ...
  public void testInstance() throws Throwable {
    ...
    assertNull(instanceModel.getInstanceCrn());
    assertNull(instanceModel.getPlan());
    assertNull(instanceModel.getVaultCluster());
    assertNull(instanceModel.getEndpoints());
    assertNull(instanceModel.getEncryption());
  }
}