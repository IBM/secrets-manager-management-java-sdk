...
/**
 * Unit test class for the VaultDedicatedInstanceMetadata model.
 */
public class VaultDedicatedInstanceMetadataTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testVaultDedicatedInstanceMetadata() throws Throwable {
    VaultDedicatedInstanceMetadata vaultDedicatedInstanceMetadataModel = new VaultDedicatedInstanceMetadata();
    assertNull(vaultDedicatedInstanceMetadataModel.getId());
    assertNull(vaultDedicatedInstanceMetadataModel.getPlan());
  }
}