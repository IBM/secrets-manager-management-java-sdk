...
/**
 * Unit test class for the DeleteInstanceAdmintokensOptions model.
 */
public class DeleteInstanceAdmintokensOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteInstanceAdmintokensOptions() throws Throwable {
    DeleteInstanceAdmintokensOptions deleteInstanceAdmintokensOptionsModel = new DeleteInstanceAdmintokensOptions.Builder()
      ...
      .build();
    assertEquals(deleteInstanceAdmintokensOptionsModel.instanceId(), "60b40daa-1fd3-4f35-a994-2409cc0f270c");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeleteInstanceAdmintokensOptionsError() throws Throwable {
    new DeleteInstanceAdmintokensOptions.Builder().build();
  }
